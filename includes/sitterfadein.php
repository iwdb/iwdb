...
//achten sie darauf, dass die Dtaie nicht zu groß ist.
...
//auiselsen ob das Modul Sound ahben darf
...
if (!empty($sound)) {
?>
<object type="application/x-shockwave-flash" data="fadein.swf?src=<?=$sound;?>&amp;autostart=yes&amp;streaming=yes" width="100" height="30"> 
 <param name="movie" value="fadein.swf?src=<?=$sound;?>&amp;autostart=yes&amp;streaming=yes" /> 
 <param name="quality" value="high" /> 
 <param name="bgcolor" value="#C4D7DF" /> 
<EMBED src="<?=$sound;?>" autostart=true loop=1 volume=100 hidden=true><NOEMBED><BGSOUND src="<?=$sound;?>"></NOEMBED> 
</object> 
<?php 
} 
?> 
...
?> 
<a href="index.php?sid=<?=$sid;?>&action=sitterliste">Es ist ein Auftrag offen!</a> 
<?php 
}
?> 
<?php 
...
?> 
<a href="index.php?sid=<?=$sid;?>&action=sitterliste"><b class="doc_red">Es ist ein Forschungsauftrag offen!</b></a> 
<?php 
}
?> 
<?php 
if ( ($anzahl > 1) AND ($anzahl_n == 0) ) { 
?> 
<a href="index.php?sid=<?=$sid;?>&action=sitterliste">Es sind <?=$anzahl;?> Auftr&auml;ge offen!</a> 
<?php 
}
?> 
<?php 
if ( ($anzahl > 1) AND ($anzahl_n >= 1) ) { 
?> 
<a href="index.php?sid=<?=$sid;?>&action=sitterliste"><span class="doc_red">Es sind <?=$anzahl;?> Auftr&auml;ge offen!</span></a> 
<?php 
}
?> 
  </td>
