...
CREATE TABLE IF NOT EXISTS `prefix_lieferung` (
  ...
  `eisen` int(10) unsigned DEFAULT '0',
  `stahl` int(10) unsigned DEFAULT '0',
  `vv4a` int(10) unsigned DEFAULT '0',
  `chem` int(10) unsigned DEFAULT '0',
  `eis` int(10) unsigned DEFAULT '0',
  `wasser` int(10) unsigned DEFAULT '0',
  `energie` int(10) unsigned DEFAULT '0',
