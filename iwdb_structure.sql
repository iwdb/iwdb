...
--
-- Host: localhost
-- Erstellungszeit: 18. Mai 2012 um 05:25
...
CREATE TABLE IF NOT EXISTS `prefix_gebaeude` (
  ...
  `typ` varchar(6) NOT NULL DEFAULT '',
  `kostet` varchar(200) NOT NULL,
  `id_iw` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Gebäudekurzform' AUTO_INCREMENT=144 ;
...
CREATE TABLE IF NOT EXISTS `prefix_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Menüstruktur' AUTO_INCREMENT=27 ;
...
CREATE TABLE IF NOT EXISTS `prefix_research` (
  ...
  `gameversion` varchar(10) NOT NULL DEFAULT 'XII',
  `reingestellt` varchar(50) DEFAULT NULL,
  `FPakt` int(10) unsigned NOT NULL DEFAULT '0',
  `time` int(12) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`),
  UNIQUE KEY `name` (`name`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Forschungsinformation für Forschung Id' AUTO_INCREMENT=272 ;
...
CREATE TABLE IF NOT EXISTS `prefix_ressuebersicht` (
  ...
  `last_xml_try` int(11) NOT NULL DEFAULT '0',
  `xml_valid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`user`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
