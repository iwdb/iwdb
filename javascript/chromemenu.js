...
var cssdropdown = {
    ...
    dropdownindicator: '<img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAkAAAAFAQAAAAC/KPvGAAAAAnRSTlMAAQGU/a4AAAAVSURBVHgBYwCChgYmRwYmJQYmEQYADY0BfuVXc98AAAAASUVORK5CYII=" />', //specify full HTML to add to end of each menu item with a drop down menu
    ...
    positionshim: function () { //display iframe shim function
        if (this.iframeshimadded) {
            if (this.dropmenuobj.style.visibility === "visible") {
                ...
                this.shimobject.style.left = parseInt(this.dropmenuobj.style.left, 10) + "px";
                this.shimobject.style.top = parseInt(this.dropmenuobj.style.top, 10) + "px";
