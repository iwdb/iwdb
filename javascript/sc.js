...
function SondenRechnen() {
    ...
    //kein leeres Eingabefeld
    if (document.getElementById('SD01').value === '') {
        document.getElementById('SD01').value = 0;
    }
    if (document.getElementById('SD02').value === '') {
        document.getElementById('SD02').value = 0;
    }

    var AnzahlSD01 = +document.getElementById('SD01').value || 0;
    var AnzahlSD02 = +document.getElementById('SD02').value || 0;
