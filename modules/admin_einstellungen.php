...
<br>
<form method="POST" action="index.php?action=admin&amp;uaction=einstellungen&amp;send=sound&amp;sid=<?=$sid;?>" enctype="multipart/form-data">
<table border="0" cellpadding="4" cellspacing="1" class="bordercolor" style="width: 80%;">
 ...
 <tr>
  ...
  <td class="windowbg1">
   <input type="checkbox" name="sound_login" <?=$sel_login;?> value="1">Yes
  </td>
 </tr>
 <tr>
  <td class="windowbg2" style="width:40%;">
  ...
  <td class="windowbg1">
    <select value="<?=$sel_val;?>" name="sound_global" size="1">
        <option <?=$sel0;?> value="0">ausgeschaltet</option> 
        <option <?=$sel1;?> value="1">fenster</option> 
        <option <?=$sel2;?> value="2">fenster mit sound</option> 
        <option <?=$sel3;?> value="3">fenster (blinkend)</option> 
        <option <?=$sel4;?> value="4">fenster (blinkend) mit Sound</option> 
    </select>
  </td>
 </tr>
 <tr>
  ...
  <td class="windowbg1">
   <input type="radio" name="sound_standart" <?=$sel_sel;?> value="1">Sound eingeschaltet
   <input type="radio" name="sound_standart" <?=$sel_not;?> value="0">Sound ausgeschaltet
  </td>
 </tr>
 <tr>
...
<form method="POST" action="index.php?action=admin&amp;uaction=einstellungen&amp;send=bericht&amp;sid=<?=$sid;?>" enctype="multipart/form-data">
<table border="0" cellpadding="4" cellspacing="1" class="bordercolor" style="width: 80%;">
 <tr>
  <td colspan="2" class="titlebg">
 ...
 <tr>
  ...
  <td class="windowbg1">
    Rang:<br>
    <select value="<?=$sel_val;?>" name="bericht_fuer_rang" size="1">
        <option <?=$sel0;?> value="all">Alle</option> 
        <option <?=$sel1a;?> value="mv">MV / HC und Admin</option> 
        <option <?=$sel1b;?> value="hc">HC und Admin</option> 
        <option <?=$sel2;?> value="admin">Admin</option> 
    </select>
     <br><br>
    Sittertyp:<br>
    <select value="<?=$sitter_val;?>" name="bericht_fuer_sitter" size="1">
    <?php
