...
{
    global $user_status;
    global $db, $db_tb_user, $db_tb_punktelog, $db_tb_schiffe, $db_tb_preset, $db_tb_lager, $db_tb_ressuebersicht, $db_tb_research2user, $db_tb_group_user, $db_tb_gebaeude_spieler, $db_tb_bestellung, $db_tb_user_research;
