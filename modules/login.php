...
<form method='POST' action='index.php?action=memberlogin2' enctype='multipart/form-data'>
    <table class='table_format' style="margin: 0 auto;">
        <tr>
            ...
            <td class='windowbg1'><input style='width: 200px' type='text' name='login_id' placeholder='IW-Name' required='required'></td>
        </tr>
        <tr>
            <td class='windowbg2'>Passwort:&nbsp;</td>
            <td class='windowbg1'><input style='width: 200px' type='password' name='login_password' placeholder='Passwort' required='required'></td>
        </tr>
        <tr>
