...
//
$moduldesc = "Zeigt die Gebäde&uml;bersicht an";
...
function workInstallDatabase() {
	...
	$sqlscript = array(
		...
		"INSERT INTO " . $db_tb_parser . " (`modulename`,`recognizer`,`message`) VALUES ('gebaeudeuebersicht','Gebäudeübersicht','Gebäudeübersicht')",
	);
