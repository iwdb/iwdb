...
echo "  <td class='left' style='width: 10%; padding:4px;'>Stargate</td>\n";
echo "  <td style='width: 4%; background-color: " . $config_color['SchwarzesLoch'] . "'></td>\n";
echo "  <td class='left' style='width: 14%; padding:4px;>Schwarzes Loch</td>\n";
echo "  <td style='width: 4%; background-color: " . $config_color['first24h'] . "'></td>\n";
echo "  <td class='left' style='width: 14%; padding:4px;>jünger 24 Stunden</td>\n";
echo "  <td style='width: 4%; background-color: #00FF00'></td>\n";
echo "  <td class='left' style='width: 14%; padding:4px;>älter 24 Stunden</td>\n";
echo "  <td style='width: 4%; background-color: #FFFF00'></td>\n";
echo "  <td class='left' style='width: 14%; padding:4px;>" . (round($config_map_timeout / 2 / DAY)) . " Tage alt</td>\n";
echo "  <td style='width: 4%; background-color: " . $config_color['scanoutdated'] . "'></td>\n";
echo "  <td class='left' style='width: 14%; padding:4px;>älter als " . (round($config_map_timeout / DAY)) . " Tage</td>\n";
echo " </tr>\n";
echo "</table>\n";