...
if ( ( ( $ansicht == "auto") && ( $objekt != "---" ) ) || ( $ansicht == "taktisch") || ( $ansicht == "beide") )
{
	?>
		...
		<a
			href="index.php?action=showgalaxy&amp;user=<?php echourlencode($row['user']);?>&amp;order=user&amp;orderd=desc&amp;sid=<?php echo$sid;?>"><img
			src="bilder/desc.gif" border="0"></a> <b>Spieler-<br>
		name</b> <a
			href="index.php?action=showgalaxy&amp;user=<?php echourlencode($row['user']);?>&amp;order=user&amp;orderd=asc&amp;sid=<?php echo$sid;?>"><img
...
if ( ( ( $ansicht == "auto") && ( $objekt != "---" ) ) || ( $ansicht == "taktisch") || ( $ansicht == "beide") )
{
	?>
		...
		<a
			href="index.php?action=showgalaxy&amp;user=<?php echourlencode($row['user']);?>&amp;exact=1&amp;sid=<?php echo$sid;?>"><?php echo$row['user'];?></a>
		</td>
		<td class="windowbg2" style="width: <?php echo(12 / $teiler);?>%; background-color: <?php echo$color;?>;" valign="middle" align="center">
		<a
...
<?php 		  	if ( strlen($rating_normal) > 0 ) 	{ ?>
		<td class="windowbg2" align="center" style="width: <?php echo(10 / $teiler);?>%; background-color: <?php echo$color;?>;" >
		<a
			href="index.php?action=showplanet&amp;coords=<?php echo$row['coords'];?>&amp;ansicht=<?php echo$ansicht;?>&amp;sid=<?php echo$sid;?>"><?php echosprintf("%.2f", $row['rating_normal']);?></a>
		</td>
		<?php 	} ?>
<?php 		  	if ( strlen($rating_best_tt) > 0 ) 	{ ?>
		<td class="windowbg2" align="center" style="width: <?php echo(10 / $teiler);?>%; background-color: <?php echo$color;?>;" >
		<a
			href="index.php?action=showplanet&amp;coords=<?php echo$row['coords'];?>&amp;ansicht=<?php echo$ansicht;?>&amp;sid=<?php echo$sid;?>"><?php echosprintf("%.2f", $row['rating_best_tt']);?></a>
		</td>
		<?php 	} ?>
<?php 		  	if ( strlen($rating_eisen_tt) > 0 ) 	{ ?>
		<td class="windowbg2" align="center" style="width: <?php echo(10 / $teiler);?>%; background-color: <?php echo$color;?>;" >
		<a
			href="index.php?action=showplanet&amp;coords=<?php echo$row['coords'];?>&amp;ansicht=<?php echo$ansicht;?>&amp;sid=<?php echo$sid;?>"><?php echosprintf("%.2f", $row['rating_eisen_tt']);?></a>
		</td>
		<?php 	} ?>
<?php 		  	if ( strlen($rating_chemie_tt) > 0 ) 	{ ?>
		<td class="windowbg2" align="center" style="width: <?php echo(10 / $teiler);?>%; background-color: <?php echo$color;?>;" >
		<a
			href="index.php?action=showplanet&amp;coords=<?php echo$row['coords'];?>&amp;ansicht=<?php echo$ansicht;?>&amp;sid=<?php echo$sid;?>"><?php echosprintf("%.2f", $row['rating_chemie_tt']);?></a>
		</td>
		<?php 	} ?>
<?php 		  	if ( strlen($rating_eis_tt) > 0 ) 	{ ?>
		<td class="windowbg2" align="center" style="width: <?php echo(10 / $teiler);?>%; background-color: <?php echo$color;?>;" >
		<a
			href="index.php?action=showplanet&amp;coords=<?php echo$row['coords'];?>&amp;ansicht=<?php echo$ansicht;?>&amp;sid=<?php echo$sid;?>"><?php echosprintf("%.2f", $row['rating_eis_tt']);?></a>
		</td>
		<?php 	} ?>
