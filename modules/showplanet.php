...
<table border="0" cellpadding="4" cellspacing="1" class="bordercolor"
	...
	if ( $user_planibilder == "1" )
	{
		...
		?>
	<tr>
		<td colspan="2" align="center"><img src="<?=$path;?>" border="0"
			alt="<?=$row['typ']?>"></td>
	</tr>
	<?php
}
?>
	...
	<tr>
		...
		<td class="windowbg1"><?=$row['coords'];?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="windowbg1"><?=$row['user'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">Allianz:</td>
		<td class="windowbg1" style=" background-color: <?=$color;?>;"><a
	...
	<tr>
		...
		<td class="windowbg1"><?=$row['planetenname'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">Punkte:</td>
		<td class="windowbg1"><?=$row['punkte'];?></td>
	</tr>
	<?php
}
?>
	...
	<tr>
		...
		<td class="windowbg1"><?=$row['typ'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">Objekttyp:</td>
		<td class="windowbg1"><?=$row['objekt'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">Planetengr&ouml;&szlig;e:</td>
		<td class="windowbg1"><?=$row['bevoelkerungsanzahl'];?></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="windowbg1"><?=$row['gravitation'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">Forschungsmod.:</td>
		<td class="windowbg1"><?=($row['fmod'] < 100) ? "<div class='doc_red'>" . $row['fmod'] . " %</div>": $row['fmod'] . ' %';?>
		</td>
	</tr>
	<tr>
		<td class="windowbg2">Geb&auml;udekostenmod.:</td>
		<td class="windowbg1"><?=($row['kgmod'] > 1) ? "<div class='doc_red'>" . $row['kgmod'] . "</div>": $row['kgmod'];?>
		</td>
	</tr>
	<tr>
		<td class="windowbg2">Geb&auml;udedauermod.:</td>
		<td class="windowbg1"><?=($row['dgmod'] > 1) ? "<div class='doc_red'>" . $row['dgmod'] . "</div>": $row['dgmod'];?>
		</td>
	</tr>
	<tr>
		<td class="windowbg2">Schiffskostenmod.:</td>
		<td class="windowbg1"><?=($row['ksmod'] > 1) ? "<div class='doc_red'>" . $row['ksmod'] . "</div>": $row['ksmod'];?>
		</td>
	</tr>
	<tr>
		<td class="windowbg2">Schiffsdauermod.:</td>
		<td class="windowbg1"><?=($row['dsmod'] > 1) ? "<div class='doc_red'>" . $row['dsmod'] . "</div>": $row['dsmod'];?>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="windowbg1"><?=($row['eisengehalt'] > 100) ? "<b>" . $row['eisengehalt'] . " %</b>": $row['eisengehalt'] . ' %';?>
		<?php echo "mit TechTeam: " ?> <?=($row['tteisen'] > 130) ? "<b>" . $row['tteisen'] . "%</b>": $row['tteisen'] . "%";?>
		<?php echo "=> effektiv Eisen: " ?> <?=($eisen_effektiv) ? "<b>" . $eisen_effektiv . "%</b>": $eisen_effektiv . "%";?>
		<?php echo "mit TechTeam: " ?> <?=($tteisen_effektiv) ? "<b>" . $tteisen_effektiv . "%</b>": $tteisen_effektiv . "%";?>
		</td>
	
	</tr>
	<tr>
		<td class="windowbg2">Chemievorkommen:</td>
		<td class="windowbg1"><?=($row['chemievorkommen'] > 100) ? "<b>" . $row['chemievorkommen'] . " %</b>": $row['chemievorkommen'] . ' %';?>
		<?php echo "mit TechTeam: " ?> <?=($row['ttchemie'] > 130) ? "<b>" . $row['ttchemie'] . "%</b>": $row['ttchemie'] . "%";?>
		<?php echo "=> effektiv Chemie: " ?> <?=($chemie_effektiv) ? "<b>" . $chemie_effektiv . "%</b>": $chemie_effektiv . "%";?>
		<?php echo "mit TechTeam: " ?> <?=($ttchemie_effektiv) ? "<b>" . $ttchemie_effektiv . "%</b>": $ttchemie_effektiv . "%";?>
		</td>
	</tr>
	<tr>
		<td class="windowbg2">Eisdichte:</td>
		<td class="windowbg1"><?=($row['eisdichte'] > 30) ? "<b>" . $row['eisdichte'] . " %</b>": $row['eisdichte'] . ' %';?>
		<?php echo "mit TechTeam: " ?> <?=($row['tteis'] > 30) ? "<b>" . $row['tteis'] . "%</b>": $row['tteis'] . "%";?>
		<?php echo "=> effektiv Eis: " ?> <?=($eis_effektiv) ? "<b>" . $eis_effektiv . "%</b>": $eis_effektiv . "%";?>
		<?php echo "mit TechTeam: " ?> <?=($tteis_effektiv) ? "<b>" . $tteis_effektiv . "%</b>": $tteis_effektiv . "%";?>
		</td>
	</tr>
	<tr>
		<td class="windowbg2">Lebensbedingungen:</td>
		<td class="windowbg1"><?=($row['lebensbedingungen'] > 100) ? "<b>" . $row['lebensbedingungen'] . " %</b>": $row['lebensbedingungen'] . ' %';?>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2" class="windowbg2"><?= !empty($row['besonderheiten']) ? str_replace(", ", "<br>", $row['besonderheiten']): "keine *moep*";?>
		</td>
	</tr>
	<tr>
...
Dieser Planet wird vorraussichtlich in <?= makeduration($row['geoscantime'] + $row['reset_timestamp']) ?> (plusminus 24h) für den Bau einer Hyperraumumgehungsstrasse gesprengt.
		</td>
	</tr>
	<?php
}
if ( $row['objekt'] == "---" )
{
	...
	<tr>
		<td colspan="2" class="windowbg2" align="center"><b><?=(!empty($rating) ? "<div class='doc_big_black'>" . $rating : "<div class='doc_red'>Kein Rating berechenbar, neuer Geoscan erforderlich");?>
		</div>
		</b></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<form method="POST"
			action="index.php?action=showplanet&amp;coords=<?=$row['coords'];?>&amp;sid=<?=$sid;?>"
...
if ( ( ( $ansicht == "auto") && ( $row['objekt'] != "---" ) ) || ( $ansicht == "taktisch") || ( $ansicht == "beide") )
{
	...
	<tr>
		...
		<td class="windowbg1"><?=$row['eisen'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">Stahl:</td>
		<td class="windowbg1"><?=$row['stahl'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">VV4A:</td>
		<td class="windowbg1"><?=$row['vv4a'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">Chemie:</td>
		<td class="windowbg1"><?=$row['chemie'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">Eis:</td>
		<td class="windowbg1"><?=$row['eis'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">Wasser:</td>
		<td class="windowbg1"><?=$row['wasser'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">Energie:</td>
		<td class="windowbg1"><?=$row['energie'];?></td>
	...
	<tr>
		...
		<td class="windowbg1"><?=$class1;?></td>
	</tr>
	<tr>
		<td class="windowbg2">Klasse 2:</td>
		<td class="windowbg1"><?=$class2;?></td>
	</tr>
	...
	<tr>
		<td colspan="2" class="titlebg"><b>Lagerkapazitï¿½t:</b></td>
	</tr>
	<tr>
		<td class="windowbg2">Lager Chemie:</td>
		<td class="windowbg1"><?=$row['lager_chemie'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">Lager Eis:</td>
		<td class="windowbg1"><?=$row['lager_eis'];?></td>
	</tr>
	<tr>
		<td class="windowbg2">Lager Energie:</td>
		<td class="windowbg1"><?=$row['lager_energie'];?></td>
	</tr>
...
if ( ! empty($row['geb']) )
{
	...
	<tr>
		<td class="windowbg1" colspan="2"><?=$row['geb'];?></td>
	</tr>
	<?php
}
?>
...
if ( ! empty($row['plan']) )
{
	...
	<tr>
		<td class="windowbg1" colspan="2"><?=$row['plan'];?></td>
	</tr>
	<?php
}
?>
...
if ( ! empty($row['stat']) )
{
	...
	<tr>
		<td class="windowbg1" colspan="2"><?=$row['stat'];?></td>
	</tr>
	<?php
}
?>
...
if ( ! empty($row['def']) )
{
	...
	<tr>
		<td class="windowbg1" colspan="2"><?=$row['def'];?></td>
	</tr>
