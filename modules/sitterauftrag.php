...
<table class="table_format" style="width: 90%;">
    ...
    while ((isset($result_act) && ($row = $db->db_fetch_array($result_act))) || ($row = $db->db_fetch_array($result))) {
        ...
        <tr>
            ...
            <?php
            if (!isset($row['planet_farbe'])) {
                $row['planet_farbe'] = "white";
            }
            ?>
        ...
        <tr>
            <td class="windowbg1" colspan="2">
                <table border="0" cellpadding="4" cellspacing="4" style="width: 100%;">
                    <tr>
                        <td colspan="2" class="windowbg2">Zeiten ohne Bauschleifenmodifikator
                            (x <?php echo $bauschleifenmod;?>) und Planetenmodifikator.
                        </td>
                    </tr>
                    <?php
                    $catprev = "";
