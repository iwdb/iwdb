...
?>
 <tr>
  ...
  <td class="windowbg1">
   <input type="text" name="date_b2" id="date_b2_<?php echo$row['id'];?>" value="<?php echostrftime($config_sitter_timeformat, $row['date_b2']);?>" style="width: 200;">
  </td>
 </tr>
<?php
	}
...
?>
 <tr>
  ...
  <td class="windowbg1">
   <input type="text" name="date_b1" id="date_b1_<?php echo$row['id'];?>" value="<?php echostrftime($config_sitter_timeformat, $row['date_b1']);?>" style="width: 120;">
   <input type="button" name="kopieren" value="kopieren" onclick="kopiere_zeit('<?php echo$row['id'];?>');">
  </td>
 </tr>
<?php
...
?>
 <tr>
  ...
  <td class="windowbg1">
   <input type="text" name="date" id="date_<?php echo$row['id'];?>" value="<?php echostrftime($config_sitter_timeformat, $row['date']);?>" style="width: 200;">
  </td>
 </tr>
...
?>
  ...
  <td class="windowbg1">
   <?php echo( empty($row['date_b2']) || empty($row['bauschleife']) || $row['date_b2'] == $row['date_b1'] ) ? "": strftime($config_sitter_timeformat, $row['date_b2']) . "<br>";?><?php echo( empty($row['date_b1']) || empty($row['bauschleife']) || $row['date_b1'] == $row['date'] ) ? "": strftime($config_sitter_timeformat, $row['date_b1']) . "<br>";?><?php echostrftime($config_sitter_timeformat, $row['date']);?>
  </td>
  <td class="windowbg1">
   <?php echo$row_planet['planetenname'];?> [<?php echo$row['planet'];?>]
  </td>
