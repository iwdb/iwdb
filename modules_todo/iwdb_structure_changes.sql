...
-- patsch 26.01. für Raidmodul, user gesperrt oder umode rausfiltern
ALTER TABLE  `prefix_highscore` ADD `umode` BOOLEAN NOT NULL DEFAULT '0';
ALTER TABLE  `prefix_highscore` ADD `gesperrt` BOOLEAN NOT NULL DEFAULT '0';
