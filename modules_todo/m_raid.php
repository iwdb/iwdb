...
if (empty($params['view'])) {
	...
	echo "<input type='checkbox' name='no_umode' value='1' checked='checked'> keine Spieler im Umode";
	echo "<input type='checkbox' name='umode' value='1'> nur Spieler im Umode<br>";
	echo "<input type='checkbox' name='no_gesperrt' value='1' checked='checked'> keine gesperrten Spieler";
	...
	$sql_select .= "," . $db_tb_highscore . ".umode";
	$sql_select .= "," . $db_tb_highscore . ".gesperrt";
